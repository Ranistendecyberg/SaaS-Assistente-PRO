...
OutputDir=dist
OutputBaseFilename=Instalador_SaaS_Assistente_PRO_v2.1.4
...
Source: "dist\SaaS Assistente PRO v2.1.4.exe"; DestDir: "{app}"; DestName: "SaaS Assistente PRO.exe"; Flags: ignoreversion
